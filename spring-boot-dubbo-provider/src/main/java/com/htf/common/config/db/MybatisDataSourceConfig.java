...
public class MybatisDataSourceConfig {
    ...
    @Primary
    public DataSourceTransactionManager mybatisTransactionManager(@Qualifier("writeDataSource") DataSource dataSource) {
    ...
    @Primary
    public SqlSessionFactory mybatisSqlSessionFactory(@Qualifier("writeDataSource") DataSource dataSource) throws Exception {
